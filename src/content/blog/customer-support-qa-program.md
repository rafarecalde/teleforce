---
title: "Building a Customer Support QA Program"
metaTitle: "Customer Support Quality Assurance Program | Teleforce"
...
- Customer identity verified where required
- Accurate information given (no misinformation about policies, pricing, or timelines)
- Compliance language used where required

**Soft criteria** (scored on a scale):
- Tone and empathy
- First-contact resolution attempt
- Resolution speed relative to complexity
...
> **Your QA program is only as good as what it coaches.** Teleforce builds calibration and feedback loops into every dedicated team from day one. [Book a call →](/#contact)
...
For more on which metrics to watch as leading indicators of customer behavior, see our post on [metrics that predict customer churn](/blog/customer-support-metrics-predict-churn).
...
- **Random sampling** across all agents and channels, to maintain baseline consistency
- **Triggered reviews** for escalated tickets, refund requests, or interactions flagged by CSAT responses
- **Agent-specific sampling** when someone is new, returning from leave, or showing performance variance
...
Understanding how to interpret CSAT, NPS, and CES together helps you triangulate where quality breakdowns are actually occurring. Our breakdown of [CSAT vs. NPS vs. CES](/blog/csat-vs-nps-vs-ces) covers how to read those signals alongside your QA data.
